...
The revolutionary PostgreSQL 8.0 introduced a more sophisticated memory manager, the two queues.\newline 

The buffer manager keeps three list of pointers to the buffer pages called cache directory blocks (CDB) T1,T2 and B1.

The pointers in T1 and T2 point actually shared buffer's pages. 
