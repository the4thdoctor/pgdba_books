...
We'll start with the top layer, looking to the data files, then we'll move to the data 
pages and finally we'll reach the fundamental storage unit, the tuples.  There is a 
dedicated section for the tablespaces and finally the physical aspect of the 
MVCC\index{MVCC}.
