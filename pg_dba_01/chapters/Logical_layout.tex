...
When a client begins a connection to PostgreSQL the process pass through few steps. 

The first connection's stage is the check using host based authentication. The cluster scans the
...
We'll now take a look to the simplest authentication's method.
